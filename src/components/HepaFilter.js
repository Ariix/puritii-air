...
const HepaFilter = () => {
  ...
  return (
      <div ref={ref} className={`hepa-section ${onScreen2 ? "active" : ""}`}>
        <figure className="square orange" ></figure>
        <figure className="square blue" ></figure>
        <img  className="grey dots rellax" src={dots} alt="" data-rellax-speed="-4"/>

        <div className="text-wrap">
          <div className="hepa-text-area hide-on-desktop">
        ...
        <div>
          {onScreen ? (
          <div className="hepa-filter-top-wrapper">
